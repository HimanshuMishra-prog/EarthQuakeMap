...
public abstract class CommonMarker extends SimplePointMarker {
	...
	//Whenever the main class draw method is called than this markers draw method is called
	//we draw a marker only id it is not hiddden  also we see if marker is selected or not
	//also selected is a parent variable
