...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public EarthquakeMarker (PointFeature feature) 
	{
		...
		//we add a additional property of radius anf put the put it in the marker
	...
	// For sorting purpose
	 public int compareTo(EarthquakeMarker marker) {
		 Float magnitudeOfCaller = this.getMagnitude();
		 Float magnitudeOfCalle = marker.getMagnitude();
		 return -(magnitudeOfCaller.compareTo(magnitudeOfCalle));
	 }
	
	
	// calls abstract method drawEarthquake and then checks age and draws X if needed
	@Override
	//see this implememation of marker drwaing is left to child class we just in this method
	// put X on the recent quakes
